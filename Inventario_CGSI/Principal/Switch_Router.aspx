<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Principal/MasterPage.Master" CodeBehind="Switch_Router.aspx.cs" Inherits="Inventario_CGSI.Principal.Routers" %>
        ...
        <ContentTemplate>
            ...
            <div id="divArticulos" runat="server" class="divTablas">
                ...
                <asp:SqlDataSource ID="SqlDataSourceArticulosSR" runat="server" ConnectionString="<%$ ConnectionStrings:inventarioConnectionString %>" SelectCommand="SELECT [ID], [Tipo], [NoSerie], [Nombre], [Modelo], [Marca], [Estatus] FROM [vista_dispositivos] WHERE ([Clasificación] = @Clasificación)">
                    <SelectParameters>
                        <asp:Parameter DefaultValue="SWITCH Y ROUTER" Name="Clasificación" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
                            ...
                            <table class="tabla_td">
                                <tr>
                                    ...
                                    <td class="horizontal">
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSourceDispositivosPerteneceA" runat="server" ConnectionString="<%$ ConnectionStrings:inventarioConnectionString %>" SelectCommand="SELECT * FROM [vista_dispositivos_perteneceA] WHERE Clasificación='SWITCH Y ROUTER'"></asp:SqlDataSource>
                                    </td>
                                    <td class="horizontal">
                                        <label>Puertos:</label>
