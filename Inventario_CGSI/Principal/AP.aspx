<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Principal/MasterPage.Master" CodeBehind="AP.aspx.cs" Inherits="Inventario_CGSI.Principal.AP" EnableEventValidation="false" %>
<%@ MasterType VirtualPath="~/Principal/MasterPage.Master" %>
    ...
    <asp:UpdatePanel ID="panelActualizacion" runat="server">
        <ContentTemplate>
            ...
            <div id="divArticulos" runat="server" class="divTablas">
                ...
                <asp:GridView CssClass="tablas" ID="GridViewArticulos" runat="server" HeaderStyle-CssClass="tablasEncabezados" AutoGenerateColumns="False" AllowSorting="True" OnSorting="GridViewArticulos_Sorting" DataKeyNames="ID" DataSourceID="SqlDataSourceAP_Articulos" OnRowCommand="GridViewArticulos_RowCommand">
                    <Columns>
                ...
                <asp:SqlDataSource ID="SqlDataSourceAP_Articulos" runat="server" ConnectionString="<%$ ConnectionStrings:inventarioConnectionString %>" SelectCommand="SELECT * FROM [vista_dispositivos] WHERE ([Clasificación] = @Clasificación)">
                    <SelectParameters>
                        <asp:Parameter DefaultValue="ACCESS POINT" Name="Clasificación" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
            ...
            <div id="divPartes" runat="server" class="divTablas" visible="false">
                ...
                <asp:GridView CssClass="tablas" ID="GridViewPartes" runat="server" HeaderStyle-CssClass="tablasEncabezados" AutoGenerateColumns="False" AllowSorting="True" DataSourceID="SqlDataSourceAP_Partes" OnRowCommand="GridViewPartes_RowCommand" DataKeyNames="ID" OnSorting="GridViewPartes_Sorting">
                    <HeaderStyle CssClass="tablasEncabezados" />
                    <Columns>
                        <asp:BoundField DataField="ID" HeaderText="ID" ReadOnly="True" SortExpression="ID" />
                        <asp:BoundField DataField="Tipo" HeaderText="Tipo" SortExpression="Tipo" />
                ...
                <asp:SqlDataSource ID="SqlDataSourceAP_Partes" runat="server" ConnectionString="<%$ ConnectionStrings:inventarioConnectionString %>" SelectCommand="SELECT [ID], [Tipo], [NoSerie], [Modelo], [Marca], [Tamaño], [Estatus] FROM [vista_partes] WHERE ([Clasificación] = @Clasificación)">
                    <SelectParameters>
                        <asp:Parameter DefaultValue="ACCESS POINT" Name="Clasificación" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
                        ...
                        <td class="horizontal">
                            <table class="tabla_td">
                                <tr>
                                    ...
                                    <td class="horizontal">Ligado con:<br />
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSourceDispositivosPerteneceA" runat="server" ConnectionString="<%$ ConnectionStrings:inventarioConnectionString %>" SelectCommand="SELECT * FROM [vista_dispositivos_perteneceA] WHERE Clasificación='ACCESS POINT'"></asp:SqlDataSource>
                                    </td>
                                    <td class="horizontal">
                                        <label>Puertos:</label>
                    ...
                    <tr>
                        ...
                        <td class="horizontal">
                            <table class="tabla_td">
                                <tr>
                                    <td class="horizontal">
                                        <asp:Image runat="server" ID="ImagePartes" CssClass="imagen_detalle" Visible="false" />
                                        <br />
                                        <asp:Label runat="server" ID="lbl_Imagen_actual_part"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="horizontal">
