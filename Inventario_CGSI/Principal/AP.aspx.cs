...
namespace Inventario_CGSI.Principal
{
    ...
    public partial class AP : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                SQLInjects inject = new SQLInjects();
                buscar_wirelessTableAdapter datosBusqueda = new buscar_wirelessTableAdapter();
                buscar_wireless_partesTableAdapter datosBusquedaPartes = new buscar_wireless_partesTableAdapter();
                ...
                GridViewPartes.DataSource = datosBusquedaPartes.GetData(inject.Remover(TextBoxBusquedaPartes.Text));
                DataBind(); 
                if (Session["DivActivo"].ToString().Equals("ModificarParte"))
                {
                    ModificarParte(int.Parse(Session["ID_Parte"].ToString()));
                }
                else if (Session["DivActivo"].ToString().Equals("ModificarArticulo"))
                {
                ...
                else if (Session["DivActivo"].ToString().Equals("DetalleParte"))
                {
                    DetalleParte(int.Parse(Session["ID_Parte"].ToString()));
                }

                else if (Session["DivActivo"].ToString().Equals("DetalleArticulo"))
                {
        ...
        public void Enviar_Partes_Global()
        {
            ...
            Session["Modelo"] = DDLModelo_Parte.SelectedValue.ToString();
        ...
        public void Agregar_Partes()
        {
            ...
            else
            {
                try
                {
                    procedimientos.agregar_partes(1,
                        estatus,
                        id_compuesto,
                        tipo,
                        marca,
        ...
        public void Agregar_Articulos()
        {
                ...
                txtMac_6.Text.Length > 1)
            {
                ...
                try
                {
                   ...
                   && validaMac1_2 && validaMac2_2 && validaMac3_2 && validaMac4_2 && validaMac5_2 && validaMac6_2)
                        {
                            procedimientos.agregar_dispositivos_wireless(1,
                                marca,
                                modelo,
                                tipo,
                                tamano,
        ...
        public void buscar_imagenes()
        {
            ...
            else { lbl_imagen.Text = "No se encontraron imagenes en el servidor";
        ...
        protected void BuscarDatos(object sender)
        {
            ...
            {
                datos = new DataSetFuncs.buscar_wirelessDataTable();
                GridViewArticulos.DataSourceID = null;
        ...
        protected void ButtonExportarExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.Charset = "";
            string NombreArchivo = "Reporte_Wireless_" + DateTime.Now.Day + "-" + DateTime.Now.Month + "-" + DateTime.Now.Year + ".xls";
            ...
            {
                GridViewArticulos.Columns[11].Visible = false;
                GridViewArticulos.Columns[12].Visible = false;
